  ...
  <div class="mask d-flex align-items-center h-100 gradient-custom-3">
        ...
        <div class="col-12 col-md-9 col-lg-7 col-xl-6">
          <div class="card" style="border-radius: 15px;">
            <div class="card-body p-5">
              <h2 class="text-uppercase text-center mb-5">EDIT MEMBER</h2>
    ...
    <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
     ...
     <div class="form-outline mb-4">
      ...
      <input type="text" name="healt" id="form3Example3cg"class="form-control form-control-lg" value="<?= $health ?>">
     </div>

	  <br>

      <div class="d-flex justify-content-center">
      <input class="btn btn-light btn-lg" data-mdb-ripple-color="dark" style="background-color:#557C55;"type="submit" name="submit" id="submit" value="Update">
      </div>
